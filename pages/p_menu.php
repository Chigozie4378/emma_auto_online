...
<body>
                    ...
                    <div class="col">
                        <div class="product-card">
                            ...
                            <div class="product-info">
                                ...
                                <button class="btn-add-cart" onclick="addToCart(<?php echo $product['product_id']; ?>)">Add to
                                    Cart</button>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function updateCartCount() {
            fetch('cart_session.php', { method: 'POST', body: 'action=count' })
                .then(response => response.json())
                .then(data => {
                    document.querySelectorAll(".shopping-cart-badge").forEach(badge => {
